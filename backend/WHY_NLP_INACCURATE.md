...
**Location**: `grammar_analyzer.py` lines 225-242
...
**Location**: `argument_miner.py` lines 186-196
...
**Location**: `argument_miner.py` lines 198-211
...
**Location**: `argument_miner.py` lines 294-315
...
```python
# Line 230 in grammar_analyzer.py
