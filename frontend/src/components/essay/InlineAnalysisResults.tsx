        ...
        <div className="space-y-6 mt-4">
          ...
          {analysis.detailed_analysis.readability && (
            <Card>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div>
                  <p className="text-sm text-neutral-600">Flesch Reading Ease</p>
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold">
                    {analysis.detailed_analysis.readability.smog_index.toFixed(1)}
                  </p>
                </div>
              </div>
            </Card>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                <div className="text-center p-3 bg-primary-50 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-primary">
                    {
                      analysis.detailed_analysis.argumentation.argument_structure
                        .total_claims
                    }
                  </p>
                </div>
          ...
          {analysis.detailed_analysis.knowledge_graph && (
            <Card>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                <div>
                  <p className="text-sm text-neutral-600">Concepts Identified</p>
                  <p className="text-lg font-semibold">
