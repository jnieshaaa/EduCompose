    ...
    return (
      <Card className="text-center py-12">
        ...
        <p className="text-sm text-neutral-600 max-w-xs mx-auto">
          This essay was analyzed without a specific rubric. Select a rubric
          when analyzing to see rubric-based scores.
        </p>
      </Card>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <Card className="p-6">
        ...
        <div className="mt-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span
              className={`text-lg font-bold ${getScoreColor(rubric_score)}`}
            >
      ...
      <div className="space-y-4">
        ...
        {criterion_scores.map((criterion, index) => {
          const percentage =
            (criterion.points_earned / criterion.max_points) * 100;
            ...
            <Card key={criterion.criterion_id || index} className="p-5">
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  ...
                  <Badge
                    className={`inline-flex items-center gap-1 ${getScoreBadgeColor(
                      percentage
                    )}`}
                  >
      ...
      <Card className="p-5 bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
        ...
        <p className="text-sm text-blue-800">
          Scores are automatically calculated by mapping your essay's analysis
          results (grammar, coherence, argument strength, etc.) to each rubric
          criterion. Each criterion is scored based on how well your essay meets
          the rubric's performance levels.
        </p>
      </Card>
    </div>
  );
