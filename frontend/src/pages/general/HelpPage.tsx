...
const HelpPage: React.FC = () => {
  return (
    <motion.div 
      ...
      className="max-w-6xl mx-auto w-full px-6 py-4 space-y-10 pb-16"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-8">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-3xl bg-primary flex items-center justify-center text-white shadow-2xl shadow-primary/40 group-hover:scale-110 transition-transform duration-700">
            ...
            <p className="text-base sm:text-lg font-medium text-neutral-600 leading-relaxed max-w-2xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="flex gap-4 p-6 rounded-3xl bg-neutral-50 border border-neutral-100 hover:border-primary/20 transition-all group/feat shadow-sm">
                <div className="w-12 h-12 rounded-2xl bg-white border border-neutral-100 flex items-center justify-center text-primary group-hover/feat:bg-primary group-hover/feat:text-white transition-all shadow-sm">
          ...
          <div className="w-full lg:w-80 space-y-4">
            ...
            <div className="p-4 flex items-center gap-3 text-neutral-400 bg-neutral-50 rounded-2xl border border-neutral-100 shadow-sm">
      ...
      <div className="pt-16 border-t border-neutral-100 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-8 bg-white rounded-3xl border border-neutral-100 shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all group overflow-hidden relative">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm font-medium text-neutral-400 leading-relaxed uppercase tracking-wide">
                  Direct communication for technical issues, account concerns, and feature requests.
                </p>
              </div>
              ...
              <div className="bg-neutral-50 p-6 rounded-2xl border border-neutral-100 flex items-center justify-between group-hover:border-primary/20 transition-all">
                <div className="space-y-1">
                  <span className="text-[11px] uppercase font-bold text-neutral-400 tracking-[0.12em]">Official Support Inbox</span>
          ...
          <div className="p-8 bg-white rounded-3xl border border-neutral-100 shadow-sm hover:shadow-xl hover:shadow-success-default/5 transition-all group overflow-hidden relative">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm font-medium text-neutral-400 leading-relaxed uppercase tracking-wide">
                  Reach out to the platform administrator for institutional academic questions.
                </p>
              </div>
              ...
              <div className="bg-neutral-50 p-6 rounded-2xl border border-neutral-100 flex items-center justify-between group-hover:border-success-default/20 transition-all">
                <div className="space-y-1">
                  <span className="text-[11px] uppercase font-bold text-neutral-400 tracking-[0.12em]">Support Availability</span>
