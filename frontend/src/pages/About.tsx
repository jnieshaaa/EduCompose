...
import Chart from "chart.js/auto"; // Using 'chart.js/auto' for simplicity
...
const About: React.FC = () => {
  ...
  const handleTechStepClick = (step: "nlp" | "kg" | "llm") => {
    setActiveTechStep(step === activeTechStep ? null : step);
  };
  ...
  // --- Knowledge Graph Logic (Force Simulation & Drawing) ---

  // Calculate Coherence Score (moved from vanilla JS)
  ...
  // Handle Analysis Start Button Click
  const handleAnalyze = () => {
  ...
  // --- Simulation Results (Charts/Table) ---
  ...
  // Scroll Observer for Navigation (Simplified for a single component)
  useEffect(() => {
      ...
      <main>
        ...
        <section id='hero' className='bg-white py-20 md:py-32'>
          <div className='container mx-auto px-6 text-center'>
            ...
            <p className='mt-8 max-w-3xl mx-auto text-lg'>
              Empowering educators with AI-driven insights to provide deeper,
              more effective feedback on student writing, without replacing the
              human touch.
            </p>
          </div>
        </section>
        ...
        <section id='challenge' className='py-16 md:py-24'>
          <div className='container mx-auto px-6'>
            ...
            <div className='grid md:grid-cols-2 gap-12 items-center'>
              ...
              <div className='bg-white p-6 rounded-rd shadow-lg'>
            ...
            <div className='flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4 mb-8'>
              {(
                [
                  {
                    id: "nlp",
                    title: "1. NLP Analysis",
                    subtitle: "Grammar & Readability",
                  },
                  {
                    id: "kg",
                    title: "2. Knowledge Graph",
                    subtitle: "Coherence & Argument",
                  },
                  {
                    id: "llm",
                    title: "3. Insight Generation",
                    subtitle: "Synthesis with LLMs",
                  },
                ] as const
              ).map((step) => (
                <div
                  ...
                  className={`process-step text-center p-4 border-2 rounded-rd bg-white w-full md:w-1/4 transition-all duration-300 ${
                    activeTechStep === step.id
                      ? "active bg-cyan-100 border-cyan-600 transform scale-105"
            ...
            >
              {activeTechStep === "nlp" && (
                <div>
                  ...
                  <ul className='list-disc list-inside space-y-2'>
                    ...
                    <li>
                      <strong>Readability Scores:</strong> We calculate metrics
                      like Flesch-Kincaid to assess writing complexity.
                    </li>
                    <li>
                      <strong>Topic Modeling:</strong> Techniques like LDA help
                      identify the main topics, checking for prompt relevance.
                    </li>
                  </ul>
                </div>
              )}
              {activeTechStep === "kg" && (
                <div>
                  ...
                  <p className='mb-4'>
                    ...
                    *meaning* and *connections* between concepts, which is vital
                    for evaluating argument strength.
                  </p>
                  <ul className='list-disc list-inside space-y-2'>
                    <li>
                      <strong>Conceptual Coherence:</strong> We map essay terms
                      to a KG (like ConceptNet) to measure logical distance
                      between ideas. Large jumps may indicate a lack of
                      coherence.
                    </li>
                    <li>
                      <strong>Argument Connection Analysis:</strong> The system
                      traces relationships between claims and evidence. Weak or
                      missing connections signify a poorly supported argument.
                    </li>
                  </ul>
                </div>
              )}
              {activeTechStep === "llm" && (
                <div>
                  ...
                  <ul className='list-disc list-inside space-y-2'>
                    <li>
                      <strong>Synthesizing Findings:</strong> The LLM translates
                      raw data (e.g., "5 passive voice instances") into
                      descriptive summaries ("The student frequently uses
                      passive voice...").
                    </li>
                    <li>
              ...
              >
                ...
                <div className='text-center mt-6'>
                  <button
                    ...
                    disabled={
                      !isAnalysisComplete && graphIterations.current > 0
