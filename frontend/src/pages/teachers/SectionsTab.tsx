...
export function SectionsTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filters (Simplified for now or pass course props) */}
            ...
            <tbody className="divide-y divide-neutral-100">
              {sections.map((section) => (
                <tr key={section.id} className="hover:bg-neutral-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-neutral-600">{section.term}</td>
      ...
      {/* Add/Edit Modals (Inline for simplicity or update existing ones) */}
      {isAddDialogOpen && (
        <div className="fixed inset-0 bg-neutral-900/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 space-y-4">
            ...
            <div className="space-y-3">
              <input
                placeholder="Block Name (e.g. BSCS-1A)"
            ...
            <div className="flex justify-end gap-2 pt-4">
              <button onClick={() => setIsAddDialogOpen(false)} className="px-4 py-2 text-neutral-500">Cancel</button>
              <Button onClick={handleCreateSection} disabled={isCreatingSection} className="bg-primary text-white">
      ...
      {isEditDialogOpen && editingSection && (
        <div className="fixed inset-0 bg-neutral-900/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-4">
              <button onClick={() => setIsEditDialogOpen(false)} className="px-4 py-2 text-neutral-500">Cancel</button>
              <Button onClick={handleUpdateSection} className="bg-primary text-white">Update Block</Button>
            </div>
          </div>
        </div>
      )}
